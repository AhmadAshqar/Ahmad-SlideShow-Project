...
/***** signup *****/
export const SIGNUP_FIRST_NAME = document.getElementById("signup-first-name");
export const SIGNUP_FIRST_NAME_ERROR = document.getElementById("signup-first-name-error");

export const SIGNUP_LAST_NAME = document.getElementById("signup-last-name");
export const SIGNUP_LAST_NAME_ERROR = document.getElementById("signup-last-name-error");

export const SIGNUP_STATE = document.getElementById("signup-state");
export const SIGNUP_STATE_ERROR = document.getElementById("signup-state-error");

export const SIGNUP_COUNTRY = document.getElementById("signup-country");
export const SIGNUP_COUNTRY_ERROR = document.getElementById("signup-country-error");

export const SIGNUP_CITY = document.getElementById("signup-city");
export const SIGNUP_CITY_ERROR = document.getElementById("signup-city-error");

export const SIGNUP_STREET = document.getElementById("signup-street");
export const SIGNUP_STREET_ERROR = document.getElementById("signup-street-error");

export const SIGNUP_HOUSE_NUMBER = document.getElementById("signup-house-number");
export const SIGNUP_HOUSE_NUMBER_ERROR = document.getElementById("signup-house-number-error");

export const SIGNUP_ZIP = document.getElementById("signup-zip");
export const SIGNUP_ZIP_ERROR = document.getElementById("signup-zip-error");

export const SIGNUP_EMAIL = document.getElementById("signup-email");
export const SIGNUP_EMAIL_ERROR = document.getElementById("signup-email-error");

export const SIGNUP_PHONE = document.getElementById("signup-phone");
export const SIGNUP_PHONE_ERROR = document.getElementById("signup-phone-error");

export const SIGNUP_PASSWORD = document.getElementById("signup-password");
export const SIGNUP_PASSWORD_ERROR = document.getElementById("signup-password-error");

export const SIGNUP_RE_PASSWORD = document.getElementById("signup-re-password");
export const SIGNUP_RE_PASSWORD_ERROR = document.getElementById("signup-re-password-error");

export const SIGNUP_BUSINESS_BOX = document.getElementById("business-checkbox");
